...
function getInitialThemeFromDocument(): Theme {
  if (typeof document === "undefined") return DEFAULT_THEME;
  const attr =
    document.documentElement.getAttribute("data-gaia-theme") ??
    document.documentElement.getAttribute("data-theme");
  const candidate = coerceThemeCandidate(attr);
...
export function DesignProvider({ children }: { children: React.ReactNode }) {
  const [theme, setThemeState] = useState<Theme>(getInitialThemeFromDocument);
