...
export default function WealthPurchasesPage() {
  ...
  if (!state) {
    return (
      <main className="mx-auto max-w-6xl w-full space-y-4 px-0 py-6 text-[var(--gaia-text-default)] lg:py-8">
        <section className={`${surface} p-4 sm:p-5 md:p-6 text-sm gaia-muted`}>
            ...
            <table className="min-w-full text-left text-xs text-[var(--gaia-text-default)]">
              ...
              <tbody>
                {purchases.map((flow) => (
                  ...
                  >
                    <td className="py-2 pr-3 align-top text-[0.6875rem] gaia-muted">
                      {flow.date}
                    </td>
                    ...
                    <td className="px-3 py-2 align-top text-[0.6875rem] gaia-muted">
                      {flow.currency}
                    </td>
