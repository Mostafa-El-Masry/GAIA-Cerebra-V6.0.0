...
function WealthInstrumentsContent() {
  ...
  return (
    <main className="mx-auto max-w-6xl w-full space-y-6 px-0 py-6 text-[var(--gaia-text-default)] lg:py-8">
      <header className="flex flex-col gap-2 pb-4 md:flex-row md:items-end md:justify-between lg:pb-0">
        <div>
              ...
              ([currency, agg]) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    <span className="text-[0.6875rem] font-semibold uppercase tracking-wide gaia-muted">
                      {currency}
                    </span>
                    <span className="text-[0.6875rem] gaia-muted">
                      ~monthly interest
                    </span>
                  </div>
                  ...
                  <p className="mt-0.5 text-[0.6875rem] gaia-muted">
                    Principal parked:{" "}
      ...
      <section className={`${surface} p-5 md:p-6`}>
        ...
        <div className="mt-4 overflow-x-auto">
          <table className="min-w-full text-left text-xs text-[var(--gaia-text-default)]">
            <thead>
              <tr className="border-b gaia-border text-[0.6875rem] uppercase tracking-wide text-[var(--gaia-text-muted)]">
                  ...
                  >
                    <td className="py-2 pr-3 align-top">
                      <div className="flex flex-col">
                        {isEditingRow ? (
                          <input
                            className="w-full rounded-md border gaia-border bg-[var(--gaia-surface)] px-2 py-1 text-[0.6875rem] text-[var(--gaia-text-default)]"
                            value={draft.name}
                            onChange={(e) =>
                              setEditing((prev) =>
                    ...
                    <td className="px-3 py-2 align-top text-[0.6875rem] text-[var(--gaia-text-default)]">
                      {isEditingRow ? (
                        <input
                          className="w-full rounded-md border gaia-border bg-[var(--gaia-surface)] px-2 py-1 text-[0.6875rem] text-[var(--gaia-text-default)]"
                    ...
                    <td className="px-3 py-2 align-top text-right text-[0.6875rem] font-semibold text-[var(--gaia-text-strong)]">
                      {isEditingRow ? (
                        <input
                          type="number"
                          className="w-28 rounded-md border gaia-border bg-[var(--gaia-surface)] px-2 py-1 text-[0.6875rem] text-[var(--gaia-text-default)] text-right"
                    ...
                    <td className="px-3 py-2 align-top text-right text-[0.6875rem] text-[var(--gaia-text-default)]">
                      {isEditingRow ? (
                        <input
                          type="number"
                          className="w-16 rounded-md border gaia-border bg-[var(--gaia-surface)] px-2 py-1 text-[0.6875rem] text-[var(--gaia-text-default)] text-right"
                    ...
                    <td className="px-3 py-2 align-top text-right text-[0.6875rem] text-[var(--gaia-text-default)]">
                      {isEditingRow ? (
                        <input
                          type="number"
                          className="w-12 rounded-md border gaia-border bg-[var(--gaia-surface)] px-2 py-1 text-[0.6875rem] text-[var(--gaia-text-default)] text-right"
                    ...
                    <td className="px-3 py-2 align-top text-right">
                      {isEditingRow ? (
                        <div className="flex justify-end gap-2">
                          <button
                            type="button"
                            className="rounded-full border gaia-border px-2 py-1 text-[0.6875rem] text-[var(--gaia-text-default)] hover:border-[var(--gaia-contrast-bg)]"
                            onClick={() => {
                              if (isNew && state) {
                                setState((prev) =>
                                  prev
                          ...
                          <button
                            type="button"
                            disabled={saving}
                            className="rounded-full border border-[var(--gaia-contrast-bg)]/60 bg-[var(--gaia-contrast-bg)]/12 px-2 py-1 text-[0.6875rem] font-semibold text-[var(--gaia-text-default)] hover:border-[var(--gaia-contrast-bg)] disabled:opacity-60"
                            onClick={async () => {
                        ...
                        <div className="flex items-center justify-end gap-2">
                          <button
                            type="button"
                            className="rounded-full border border-[var(--gaia-contrast-bg)]/50 px-2 py-1 text-[0.6875rem] text-[var(--gaia-text-default)] hover:border-[var(--gaia-contrast-bg)]"
                            onClick={() => {
                              setIsNew(false);
                              setEditing(inst);
                            }}
                          ...
                          <button
                            ...
                            className="inline-flex items-center justify-center rounded-full border border-rose-400/60 px-2 py-1 text-[0.6875rem] text-rose-600 hover:border-rose-500"
                            onClick={async () => {
                              const next: WealthState = {
                                ...state,
