...
function computePlanSummary(
  ...
  const tracks: TrackId[] = ["programming", "self-repair"];
...
function preferredDayOrderForTrack(trackId: TrackId): number[] {
  ...
  // Programming prefers the first day of the week (Monday)
  return [1, 2, 3, 4, 0, 6, 5];
}

const TRACK_CYCLE: TrackId[] = ["programming", "self-repair"];
...
function computeBacklogByTrack(
  ...
  const totalMinutes =
    minutesByTrack.programming + minutesByTrack["self-repair"];
