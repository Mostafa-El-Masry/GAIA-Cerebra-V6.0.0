export type TrackId = "programming" | "self-repair";
  ...
  { id: "prog-0-4", trackId: "programming", code: "0.4", title: "Installations" },
  { id: "prog-0-5", trackId: "programming", code: "0.5", title: "Text Editors" },
  { id: "prog-0-6", trackId: "programming", code: "0.6", title: "Command Line Basics" },
  { id: "prog-0-7", trackId: "programming", code: "0.7", title: "Setting up Git" },
  { id: "prog-0-8", trackId: "programming", code: "0.8", title: "Introduction to Git" },
  { id: "prog-0-9", trackId: "programming", code: "0.9", title: "Git Basics" },
  ...
  { id: "prog-2-0", trackId: "programming", code: "2.0", title: "Introduction to HTML and CSS" },
  { id: "prog-2-6", trackId: "programming", code: "2.6", title: "Elements and Tags" },
  { id: "prog-2-7", trackId: "programming", code: "2.7", title: "HTML Boilerplate" },
  { id: "prog-2-8", trackId: "programming", code: "2.8", title: "Working with Text" },
  { id: "prog-2-9", trackId: "programming", code: "2.9", title: "Lists" },
  { id: "prog-2-10", trackId: "programming", code: "2.10", title: "Links and Images (Essentials)" },
  { id: "prog-2-11", trackId: "programming", code: "2.11", title: "Commit Messages" },
  { id: "prog-2-12", trackId: "programming", code: "2.12", title: "Project: Recipes" },
  { id: "prog-2-1", trackId: "programming", code: "2.1", title: "HTML Basics: Tags, Structure, and Layout" },
  { id: "prog-2-2", trackId: "programming", code: "2.2", title: "Semantic HTML: Landmarks and Meaning" },
  { id: "prog-2-3", trackId: "programming", code: "2.3", title: "Links and Navigation" },
  { id: "prog-2-4", trackId: "programming", code: "2.4", title: "Images and Alt Text" },
  { id: "prog-2-5", trackId: "programming", code: "2.5", title: "HTML Forms: Collecting Data" },
  { id: "prog-3-1", trackId: "programming", code: "3.1", title: "CSS Foundations: Selectors and Properties" },
  { id: "prog-3-2", trackId: "programming", code: "3.2", title: "Box Model: Margin, Padding, Border" },
  { id: "prog-3-3", trackId: "programming", code: "3.3", title: "Flexbox Basics: Rows and Columns" },
  ...
  { id: "prog-3-7", trackId: "programming", code: "3.7", title: "Intro to CSS" },
  { id: "prog-3-8", trackId: "programming", code: "3.8", title: "The Cascade" },
  { id: "prog-3-9", trackId: "programming", code: "3.9", title: "Inspecting HTML and CSS" },
  { id: "prog-3-10", trackId: "programming", code: "3.10", title: "The Box Model (Deep Dive)" },
