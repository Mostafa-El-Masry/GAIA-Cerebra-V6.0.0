    ...
    case "1.3":
      return {
        ...
        paragraphs: [
          ...
          "This mindset is what will carry you from the first HTML tag all the way to connected GAIA apps and other modules.",
        ],
      };
    default:
      return null;
  ...
  switch (lessonCode) {
    ...
    case "1.3":
      return {
        ...
        instructions: [
          "Write down your ideal weekly rhythm: for example, three days programming (30 / 45 / 60 minutes) and three days on another path, plus Friday for self-repair.",
